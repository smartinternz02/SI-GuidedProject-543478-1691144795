...
app = Flask(__name__)
app.secret_key = 'a'
conn = ibm_db.connect("DATABASE=bludb; HOSTNAME=6667d8e9-9d4d-4ccb-ba32-21da3bb5aafc.c1ogj3sd0tgtu0lqde00.databases.appdomain.cloud; PORT=30376; UID=lkj36861; PASSWORD=xiw5duALrXbIn4cf; SECURITY=SSL;SSLServerCertificate=DigiCertGlobalRootCA.crt", "", "")
    ...
    if request.method=="POST":
       for x in range (1,5):
        ...
        if f.filename != '':
            ...
            cos.upload_file(Filename= filepath,Bucket='<himanshuassignment>',Key= u+x+".pdf")
